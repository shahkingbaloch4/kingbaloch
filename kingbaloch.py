...
logo = '\n\x1b[1;33m         ------------\n\x1b[1;34m        \x1b[1;36m<:::\x1b[1;32mShah Dino\x1b[1;36m:::>\n\x1b[1;33m   


     /$$$$$$ /$$ /$$ /$$__ $$| $$ | $$ | $$ \__/| $$$$$$$ /$$$$$$ | $$$$$$$ | $$$$$$ | $$__ $$ |____ $$| $$__ $$ \____ $$| $$ \ $$ /$$$$$$$| $$ \ $$ /$$ \ $$| $$ | $$ /$$__ $$| $$ | $$ | $$$$$$/| $$ | $$| $$$$$$$| $$ | $$ \______/ |__/ |__/ \_______/|__/ |__/  --------------------------------------------------\n\x1b[1;95m\n AUTHOR     : SHAH DINO\n FACEBOOK   : FACEBOOK.COM/shahdinobaloch15\n GITHUB     : GITHUB.COM/Shah Dino\n\x1b[1;37m--------------------------------------------------                                '
back = 0
successful = []
cpb = []
oks = []
...
def action():
    global cpb
    global oks
    bch = raw_input('\n\x1b[1;91m\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90\xe2\x95\x90[DINO]>  ')
    if bch == '':
